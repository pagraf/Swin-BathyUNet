...
This repository contains the code of the paper "P. Agrafiotis and B. Demir, "Deep learning-based bathymetry retrieval without in-situ depths using remote sensing imagery and SfM-MVS-derived DSMs with data gaps" submitted to the ISPRS Journal of Photogrammetry and Remote Sensing"<br />
